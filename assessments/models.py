...
class UserResponse(models.Model):
    ...
    score = models.FloatField(default=0)  # ✅ добавлено
...
class Assessment(models.Model):
    # ✅ исправлено — убрал вложенность и добавил недостающие поля
    title = models.CharField(max_length=255)  # ✅ добавлено
    user = models.ForeignKey(User, on_delete=models.CASCADE)  # ✅ добавлено
